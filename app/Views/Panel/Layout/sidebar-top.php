<ul class="app-menu list-unstyled accordion" id="menu-accordion">
    <li class="nav-item">
        <a class="nav-link <?= ($active == "dashboard") ? "active" : ""; ?> ?>" href="<?= route_to('dashboard') ?>">
            <span class="nav-icon">
    ...
    <?php if (auth()->user()->getGroups()[0] == 'admin') : ?>
        <li class="nav-item">
            <a class="nav-link <?= ($active == "kriteria") ? "active" : ""; ?> ?>" href="<?= route_to('kriteria') ?>">
                <span class="nav-icon">
        ...
        <li class="nav-item">
            <a class="nav-link <?= ($active == "alternatif") ? "active" : ""; ?> ?>" href="<?= route_to('alternatif') ?>">
                <span class="nav-icon">
    ...
    <?php if (auth()->user()->getGroups()[0] == 'admin' || auth()->user()->getGroups()[0] == 'user') : ?>
        ...
        <li class="nav-item">
            <a class="nav-link <?= ($active == "hasil") ? "active" : ""; ?> ?>" href="<?= route_to('perhitungan.hasil') ?>">
                <span class="nav-icon">
    ...
    <?php if (auth()->user()->getGroups()[0] == 'admin') : ?>
        ...
        <li class="nav-item">
            <a class="nav-link <?= ($active == "user") ? "active" : ""; ?> ?>" href="<?= route_to('user') ?>">
                <span class="nav-icon">
